  ...
  <Layout>
    <PageHeader :title="title" :items="items">
      <div class="float-right">
        <router-link :to="{name: 'PaymentMethodCreate'}"
          class="btn btn-info btn-block d-inline-block"
        >
          <i class="fas fa-plus mr-1"></i> Agregar Forma de Pago
        </router-link>
      </div>
    </PageHeader>
            ...
            <div class="table-responsive mb-0">
              ...
              >
                <template #cell(actions)="row">
                  <router-link :to="{ name: 'PaymentMethodEdit', params: { paymentMethodId: row.item.id }}" class="btn btn-sm btn-success">
